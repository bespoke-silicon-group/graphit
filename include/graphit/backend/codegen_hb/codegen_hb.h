...
namespace graphit {
    ...
    public:
        CodeGenHB(std::ostream &host_oss, std::ostream &device_oss, MIRContext *mir_context) : oss_host(host_oss), oss_device(device_oss), mir_context_(mir_context), indentLevel(0), current_context(mir::FuncDecl::CONTEXT_HOST){
