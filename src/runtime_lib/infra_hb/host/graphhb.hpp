...
public:
	...
	void transpose() {
 	  Device::Ptr device = Device::GetInstance();
          ...
          int * host_inind = new int[V];
          int * host_outind = new int[V];
          ...
          _in_index.copyToHost(host_inind, V); 
          _out_index.copyToHost(host_outind, V); 
	  ...
	  device->freeze_cores();
          ...
          _in_index.copyToDevice(host_outind, V); 
          _out_index.copyToDevice(host_inind, V); 
